...
class CoRedcapProvisionerTargetsController extends SPTController {
  // Class name, used by Cake
  public $name = "CoRedcapProvisionerTargets";
  ...
  function beforeRender() {
    ...
    if(!$this->request->is('restful')) {
      $this->set('vv_identifiers_types', $this->CoRedcapProvisionerTarget->CoProvisioningTarget->Co->CoPerson->Identifier->types($this->cur_co['Co']['id'], 'type'));
    }
